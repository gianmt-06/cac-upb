import formsValidator from "../../../helper/FormsValidator";

export default class SimpleFormTemplate {
    ...
    getTemplate(){
        return `
        <form class="cancel-cita-form needs-validation" id="simple-form" novalidate>
            <div class="row">
